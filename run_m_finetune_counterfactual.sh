...
gpu_id=3
is_train=0
test_checkpoint="output/remove_space/train_m_fine_cf/model_best.ckpt"

output_dir="output/m_finetune_counterfactual"
config_train=config_train_finetune_counterfactual
