...
class ShapesTest(tf.test.TestCase):
    ...
    def test_reduce_with_weights(self):
        """Tests :func:`texar.utils.shapes.reduce_with_weights`
        """
    ...
    def test_pad_and_concat(self):
        """Tests :func:`texar.utils.shapes.pad_and_concat`.
        """
        a = tf.ones([3, 10, 2])
        b = tf.ones([4, 20, 3])
        c = tf.ones([5, 1, 4])
    ...
    def test_varlength_concat(self):
        """
        Tests :func:`texar.utils.shapes.varlength_concat`.
        """
        # 2D
        x = np.asarray(
            [[1, 1, 0, 0],
    ...
    def test_varlength_roll(self):
        """
        Tests :func:`texar.utils.shapes.varlength_roll`.
        """
        # 2D
        x = np.asarray(
            [[1, 1, 0, 0],
